...
const gameDataSchema = z.object({
  ...
  clubSeasons: z.array(
    z.object({
      ...
      progression: z.string(), finalScore: z.string(), opponentClubName: z.string(),
  ...
  playerSeasons: z.array(
    z.object({
      ...
      captain: z.boolean(), role: z.enum(["starter", "sub", "bench"]),
      finalGoals: z.number(), careerFinals: z.number(), careerFinalWins: z.number(),
